...
export async function POST(req: NextRequest) {
  try {
    ...
    // Staff-created bookings (admin_created) are cancellable by the
    // customer here too, under the same rules as any other booking —
    // staff can also still cancel one via
    // app/api/fg-admin/platform/bookings/cancel, independently.
